...
///////////////////////////////////////////////////////////////////////////////
    ...
    bool Intersect(const Ray &ray, const TriangleFast &accel, RayHit &h0) {
        ...
        const float nd =
                1.0f / (ray.m_dir.at(accel.m_k) + accel.m_nu * ray.m_dir.at(ku) + accel.m_nv * ray.m_dir.at(kv));
        float t = (accel.m_nd - ray.m_origin.at(accel.m_k) - accel.m_nu * ray.m_origin.at(ku) -
