...
namespace Nurgle {
    ...
    Unit *HorticulousSlimux::Create(const ParameterList &parameters) {
        ...
        return new HorticulousSlimux(legion, general);
    }
    ...
    HorticulousSlimux::HorticulousSlimux(PlagueLegion legion, bool isGeneral) :
            NurgleBase(legion,"Horticulous Slimux", 5, g_wounds, 10, 3, false, g_pointsPerUnit),
