...
namespace DaughtersOfKhaine {
    ...
    AvatarOfKhaine::AvatarOfKhaine(Temple temple) :
            DaughterOfKhaine(temple, "Avatar of Khaine", 9, g_wounds, 10, 4, false, g_pointsPerUnit),
    ...
    Unit *AvatarOfKhaine::Create(const ParameterList &parameters) {
        ...
        return new AvatarOfKhaine(temple);
    }
