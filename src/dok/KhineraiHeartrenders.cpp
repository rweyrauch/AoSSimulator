...
KhineraiHeartrenders::KhineraiHeartrenders() :
    ...
    m_barbedJavelinShrykeMissile(Weapon::Type::Missile, "Barbed Javelin (Shryke)", 12, 1, 2, 3, -1, 1),
    m_barbedJavelinShryke(Weapon::Type::Melee, "Barbed Javelin (Shryke)", 2, 1, 3, 4, -1, 1)
{
