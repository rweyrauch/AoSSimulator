...
constexpr std::array<int, 9> g_factionResourceName = {
        ...
        ToInteger(Resource::Ossiarch_Relentless_Discipline)
};
...
void Roster::addUnit(std::shared_ptr<Unit> unit) {
    ...
    else if (unit->hasKeyword(OSSIARCH_BONEREAPERS)) m_factionResource = Resource::Ossiarch_Relentless_Discipline;
