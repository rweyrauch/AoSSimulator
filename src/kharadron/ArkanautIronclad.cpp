...
namespace KharadronOverlords {
    ...
    Unit *ArkanautIronclad::Create(const ParameterList &parameters) {
        ...
        return new ArkanautIronclad(port, artycle, amendment, footnote, option, endrinwork);
    }
    ...
    ArkanautIronclad::ArkanautIronclad(Skyport port, Artycle artycle, Amendment amendment, Footnote footnote, WeaponOption option, Endrinwork endrinwork) :
            KharadronBase(port, artycle, amendment, footnote, "Arkanaut Ironclad", 10, g_wounds, 8, 3, true, g_pointsPerUnit),
    ...
    size_t ArkanautIronclad::getDamageTableIndex() const {
