...
namespace Fyreslayers {
    ...
    AuricRunesmiter::AuricRunesmiter(Lodge lodge, Blessing blessing, WeaponOption option, CommandTrait trait, Artefact artefact, bool isGeneral) :
            Fyreslayer(lodge, "Auric Runesmiter", 4, g_wounds, 7, 5, false, g_pointsPerUnit),
    ...
    Unit *AuricRunesmiter::Create(const ParameterList &parameters) {
        ...
        return new AuricRunesmiter(lodge, prayer, weapons, trait, artefact, general);
    }
