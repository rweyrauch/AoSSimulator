...
static FactoryMethod factoryMethod = {
    ...
    nullptr,
    {
        {ParamType::Integer, "Models", {.m_intValue = 5}, Decimators::MIN_UNIT_SIZE, Decimators::MAX_UNIT_SIZE, Decimators::MIN_UNIT_SIZE},
        {ParamType::Integer, "Starsoul Maces", {.m_intValue = 2}, 0, (Decimators::MAX_UNIT_SIZE / 5) * 2, 1}
    },
    ORDER,
    STORMCAST_ETERNAL
};
