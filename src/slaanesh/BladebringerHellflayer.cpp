...
namespace Slaanesh {
    ...
    BladebringerOnHellflayer::BladebringerOnHellflayer(Host host, Lore lore, CommandTrait trait, Artefact artefact, bool isGeneral) :
            SlaaneshBase(host, "Bladebringer, Herald on Hellflayer", 12, g_wounds, 10, 4, false, g_pointsPerUnit),
    ...
    Unit *BladebringerOnHellflayer::Create(const ParameterList &parameters) {
        ...
        return new BladebringerOnHellflayer(host, lore, trait, artefact, general);
    }
